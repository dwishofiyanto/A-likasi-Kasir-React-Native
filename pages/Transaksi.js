            ...
            <Modal
              ...
              <View>
                <FlatList
                  ...
                  renderItem={({item, index}) => (
                    <View>
                      {/* <Text>invoice {this.state.invoice}</Text> */}
                      <Text>{item.nama_produk}</Text>
                      <Text>
                        {'Rp ' +
                          item.harga_jual
                ...
                />
                <Text>Nomor Nota {this.state.invoice}</Text>
                <Text>TOTAL {this.state.sub_total}</Text>
                <Text>Nama Pembeli</Text>
                <TextInput
                  placeholder="Nama Pembeli"
                  onChangeText={nama_pembeli => set_nama_pembeli(nama_pembeli)}
                  style={{
                    padding: 5,
                    borderColor: 'skyblue',
                    borderRadius: 15,
                ...
                <Text onPress={() => this.proses_input()}>simpan</Text>
             ...
             <Modal
              isVisible={this.state.modal_nota}
              style={styles.modal}>
              <View>
                
                <Text>Nomor Nota {this.state.invoice}</Text>
                <Text>pesan {this.state.pesan}</Text>
                <Text onPress={() => this.setState({modal_nota: false})}>
                  BATAL
                </Text>
              </View>
            </Modal>
