...
import { FlatList,Image, Text, View, SafeAreaView, Alert, TouchableOpacity, Mybutton,StyleSheet } from 'react-native';
    ...
    <View style={{flex:1}}>
      <View style={styles.container}>
        <View style={styles.header}>
            ...
            <View style={[styles.box_header,styles.box_header1]}><Text>DAFTAR PRODUK</Text></View>
        </View>
